        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-6">
            <div className="grid gap-3">
              ...
              <Input className="focus:border-red-500" id="email" type="email" placeholder="m@example.com" required />
            </div>
             <div className="grid gap-3">
                ...
                <Input className="focus:border-red-600" id="password" type="password" required />
              </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Button variant="outline" type="button" className="w-full hover:border-red-600">
