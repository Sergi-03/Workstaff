...
export default function WorkerRecommendedJobs() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden">
      <div className="animate-fade-in-up py-4 sm:py-6 w-full max-w-7xl mx-auto space-y-4 sm:space-y-6 select-none px-3 sm:px-6">
              ...
              <CardContent className="pt-4 sm:pt-6 px-3 sm:px-6">
                <div className="flex items-center gap-2 text-xs sm:text-sm">
                  ...
                  <span className="font-medium">
                    Hemos encontrado {matches.length} ofertas que encajan
                    contigo
                  </span>
                </div>
              </CardContent>
            ...
            <CardContent className="pt-6">
              <div className="text-center py-8 sm:py-12">
                ...
                <p className="mt-1 text-sm text-muted-foreground px-4">
                  Completa tu perfil y añade tus habilidades para recibir
          ...
          <div className="space-y-4 sm:space-y-6">
            {matches.map((match) => {
              ...
              return (
                <Card
                  key={match.id}
                  className="group hover:shadow-xl transition-all duration-300 hover:border-red-500/50 overflow-hidden"
                >
                      ...
                      <div className="flex-1 space-y-3 min-w-0 overflow-hidden">
                        <div className="flex items-start gap-2 sm:gap-3 min-w-0">
                          ...
                          <div className="min-w-0 flex-1 overflow-hidden">
                            <CardTitle className="text-base sm:text-xl group-hover:text-red-500 transition-colors break-words">
                              {job.title}
                            </CardTitle>
                            <CardDescription className="flex items-center gap-1 mt-1 text-xs sm:text-sm min-w-0">
